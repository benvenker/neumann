...
// Export both the Radix-style components and a simple Tooltip wrapper for convenience
const Tooltip = TooltipRoot

export { Tooltip, TooltipProvider, TooltipTrigger, TooltipContent, TooltipRoot, TooltipPortal }
